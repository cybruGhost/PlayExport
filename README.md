[![Build Status](https://api.travis-ci.com/watsonbox/playExport.svg?branch=master)](https://travis-ci.com/github/watsonbox/playExport)

<a href="https://playExport.app/"><img src="assets/screenshot.png"/></a>

Export your Spotify playlists to [CSV](https://en.wikipedia.org/wiki/Comma-separated_values) by clicking on this link: [https://playExport.app/](https://playExport.app/).
...
- 🚀 [Advanced rate limiting handling](https://github.com/watsonbox/playExport/pull/75) for speedy exports
- 👩‍💻 Modern [React-based development stack](#stack) + test suite

## Usage

1. Fire up [the app](https://playExport.app/)
2. Click 'Get Started'
3. Grant playExport read-only access to your playlists
...
<a href="https://watsonbox.github.io/playExport/"><img src="https://user-images.githubusercontent.com/17737/100668594-72be1600-335c-11eb-90d6-c9ae873e347d.png"/></a>
...
<a href="https://watsonbox.github.io/playExport/"><img src="https://user-images.githubusercontent.com/17737/100201109-eb0d7d00-2eff-11eb-993e-7ed955e2361c.gif"/></a>
...
- 2015: playExport is [born](https://github.com/watsonbox/playExport/commit/b284822e12c3adea8fb83258fdb00ec4690701e1)
- 2020: [Major release](https://watsonbox.github.io/posts/2020/12/02/playExport-refresh.html) including search, artist and audio features, liked songs export, and a new rate limiting system
- 2024: [Major release](https://watsonbox.github.io/posts/2024/09/04/playExport-updates.html) including dark mode, internationalization, and search enhancements
...
- I've [gone to some lengths](https://github.com/watsonbox/playExport/pull/75) to try to eliminate errors resulting from excessively high usage of the Spotify API. Nonetheless, exporting data in bulk is a fairly request-intensive process, so please do try to use this tool responsibly. If you do require more throughput, please consider [creating your own Spotify application](https://github.com/watsonbox/playExport/issues/6#issuecomment-110793132) which you can use with playExport directly.
...
To build and run playExport with docker, run:

**`docker build . -t playExport`**

**`docker run -p 3000:3000 playExport`**

And then open [http://localhost:3000](http://localhost:3000) to view it in the browser.

## Contributing

1. Fork it ( https://github.com/watsonbox/playExport/fork )
